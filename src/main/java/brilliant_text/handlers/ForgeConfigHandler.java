...
public class ForgeConfigHandler {
    ...
    public static class ClientConfig {
        ...
        @Config.Comment({
                ...
                "Format: char=textColor (hex)|outlineColor (hex)|glowColor (hex)|particleTexture (ResourceLocation)|particleColor (hex)|particleRarity (number)|particleLifetime (number)|particleDimensions (number-number)|particleRotation (number-number)|particleRotationPerFrame (number-number)",
