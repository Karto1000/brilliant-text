...
import brilliant_text.shader.builtin.CopperShader;
import brilliant_text.shader.builtin.FlameTextShader;
import brilliant_text.shader.builtin.GoldShader;
import brilliant_text.shader.builtin.SilverShader;
...
public class BrilliantTextManager {
    ...
    public static void init() {
        ...
        BrilliantTextManager.bindCharToShader(FormatCharacter.tryFrom('s'), new SilverShader());
        BrilliantTextManager.bindCharToShader(FormatCharacter.tryFrom('q'), new CopperShader());
